...
class OptimizersTests(tf.test.TestCase):
    ...
    def test_reverse_one_step(self):
        ...
        CM_optimizer.minimize(y, var_list=[x])
        RGD_optimizer = RGDOptimizer(velocity=CM_optimizer.v_preciserep,weights=CM_optimizer.var_preciserep, learning_rate=0.2,hes=None)
    ...
    def test_reversible_NN(self):
        ...
        d_decay, d_lr =  reverse_training(model, x, y, CM_optimizer.v_preciserep, params=CM_optimizer.var_preciserep, epochs=5)
